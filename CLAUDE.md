...
| `debug` | `/debug <sentry_url OR problem description>` | Debug production issues (infra or app). Read-only diagnostics across Sentry, kubectl, CloudWatch, SQS, RDS, and source code. Returns diagnosis with confidence % |
